...
#### **Problem Description**
In this problem, we analyzed a **superalloy turbine blade** **(k<sub>b</sub>=25 W/(mK))** exposed to hot gases at **1616 K**. We first calculated the surface temperature of the blade without any protection and found it reached **1236 K**, which exceeded the maximum allowable limit **(T<sub>max</sub>)** of **1200 K**. We then re-evaluated the system after adding a thin **0.5 mm Thermal Barrier Coating** **(k<sub>TBC</sub> = 1 W/(mK))** and accounting for an interfacial thermal resistance of **10⁻⁴ m² K/W**.
...
[Homework]({{ "/assets/MAE_3240_HW3.pdf" | relative_url }}) in PDF format.